...
The code below is the full code for the application shown in the slides:
...
import 'package:flutter/material.dart';
    ...
    //                             );
                      ...
                      child: Row(
                        ...
                        children: [
                          FlatButton(
                            ...
                            children: [
                              Icon(Icons.phone),
                              Text("  +44 000 000 0000", style: Theme.of(context).textTheme.caption)
                            ],
                            ),
                          ),
                          FlatButton(
                            ...
                            children: [
                              Icon(Icons.email),
                              Text("  sidak.pasricha.17@ucl.ac.uk", style: Theme.of(context).textTheme.caption)
                            ],
                            ),
                          ),
                        ],
                    ...
                    Container(
                      ...
                      alignment: Alignment.centerLeft,
                      child: Text("Community Involvements:",
                          style: TextStyle(fontWeight: FontWeight.bold)),
                    ),
                    Container(
                      margin: EdgeInsets.only(top: 16),
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text("Microsoft Student Partner"),
                          Text("Since 2017",
                              style: TextStyle(color: Colors.grey[500])),
                        ],
                      ),
                    ...
                    Container(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text("President - UCL Technology Society"),
                          Text("2018 - 2019",
                              style: TextStyle(color: Colors.grey[500])),
                        ],
                      ),
